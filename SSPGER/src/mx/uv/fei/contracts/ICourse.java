...
public interface ICourse {
    ...
    Boolean isCourseRegistered (Course course) throws SQLException;
    int diseableCourse(int idCourse) throws SQLException;
    int modifyCourse(Course course) throws SQLException;
    int courseActive(Course course) throws SQLException;
    List<Course> getCoursesByStatus(int status) throws SQLException;
